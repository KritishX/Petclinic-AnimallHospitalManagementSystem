<%@ Page Title="Contact" Language="C#" MasterPageFile="~/Project/UserPanel.Master" AutoEventWireup="true" CodeBehind="Contact.aspx.cs" Inherits="AnimalHealthHospitalManagementSystem.Project.WebForm4" %>
                ...
                <div class="col-lg-6 wthree-form-left mt-lg-0 mt-3">
                    ...
                    <div class="contact-top1">
                        ...
                        <form action="#" method="get" class="f-color pt-3">
                            ...
                            <div>
                                <asp:Button ID="btnSend" class="btn btn-danger btn-block" runat="server" Text="Send" OnClick="btnSend_Click"  /></div>
