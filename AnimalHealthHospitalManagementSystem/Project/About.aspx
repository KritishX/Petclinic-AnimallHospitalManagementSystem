<%@ Page Title="About" Language="C#" MasterPageFile="~/Project/UserPanel.Master" AutoEventWireup="true" CodeBehind="About.aspx.cs" Inherits="AnimalHealthHospitalManagementSystem.Project.WebForm2" %>
	...
	<section class="case_w3ls  py-lg-5">
		<div class="container py-5">
			<div class="text-center wthree-title pb-sm-5 pb-3">
				...
				<h4 class="sub-title py-3">The suppsed users of a pet clinic/hospital management system may be generally following task</h5>
			</div>
			<!-- case studies row -->
			<div class="row">
				...
				<div class="col-lg-4 col-md-6 my-lg-0 mt-4">
					<div class="img1 img3 img-grid  d-flex align-items-end justify-content-center p-3">
						<div class="img_text_w3ls">
							...
							<span> </span>
							<p> Vet Doctors and other authorized</p>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-4 col-md-6  mt-4">
					<div class="img1 img4 img-grid  d-flex align-items-end justify-content-center p-3">
						<div class="img_text_w3ls">
							<h4>Animal Approach</h4>
							<span> </span>
							<p>Doctors and staff authorized </p>
						</div>
					</div>
				</div>
				<div class="col-lg-4 col-md-6 mt-4">
					<div class="img1 img6 img-grid  d-flex align-items-end justify-content-center p-3">
						<div class="img_text_w3ls">
							...
							<span> </span>
							<p>Vet Doctors and other authorized employee/staff</p>
						</div>
					</div>
				</div>
			</div>
